      ...
      <div className="container mx-auto flex flex-col items-center justify-between space-y-6 md:flex-row md:space-y-0">
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex space-x-4 justify-center md:justify-start mt-4">
            ...
            <a href="#" className="text-black hover:text-gray-600">Xing</a>
            <a href="#" className="text-black hover:text-gray-600">LinkedIn</a>
            <a href="#" className="text-black hover:text-gray-600">DTI</a>
            <a href="#" className="text-black hover:text-gray-600">CITEM</a>
          </div>
        </div>
