export const SideInfo = () => {
  return (
    <div className="absolute right-0 top-1/2 transform -translate-y-1/2 h-fit max-h-[75%] p-16 px-44 w-fit bg-primary-1 bg-opacity-90 text-primary-2">
      <div className="flex flex-col justify-center items-center gap-16 text-start font-urbanist">
        <div className="w-full max-w-xl">
          <h1 className="text-13xl font-semibold  w-full max-w-sm text-left leading-[1.2]">
            Mele + Marie: A tale of fine Philippine artistry
          </h1>
          <p className="max-w-sm text-xl">Melecio and Rosemarie Oamil</p>
        </div>
        <div className="w-full flex flex-col gap-8">
        <div className="w-full flex flex-col gap-1.5">
          <p>
            <span className="text-5xl font-bold">$ 1,100</span> / Starting Bid
          </p>
