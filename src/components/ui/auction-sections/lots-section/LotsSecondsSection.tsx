...
export const LotsSecondsSection = () => {
  return (
    <div className="flex flex-col w-full max-w-[80%] mt-24 items-center justify-center gap-8 relative">
      ...
      <div className="flex flex-col items-start gap-8 w-full">
        ...
        <p className="text-xl text-primary-2 font-urbanist">
          ...
          <span className="font-medium">
            Elegance, function, and style. When one thinks of the Filipino brand
            Mele + Marie, these are the qualities that spring to mind. The
            company has been making accessories and minaudieres with thoughtful
            narratives and avant-garde concepts since its modest beginnings.
            Each handmade and timeless piece tells a life story through wearable
            art.
            <br />
            <br />
            According to designer Rome Oamil, the second-generation owner of
            Mele + Marie, the Emman Clutch was inspired by the story of David
            and Goliath. “The story that we want to impart is that no matter how
            big your enemy or problem is in life, you have the ability to go
            through it and remain victorious.”
            <br />
            <br />
            Rome shared that their dedication to their customers drives them to
            create something that is distinct yet familiar. The bag is made of
            abalone shell wrapped in 24-k gold-dipped metal. Its shape and
            mold–from the base shell to the textured gold-plated metal, are made
            by hand. Its curved enclosure is intricately and uniquely welded to
            form uneven waves around its body. A departure from the brand&apos;s
            usual, the finishing touch is a curved handle made of shell.
            <br />
            <br />
            The original concept, fine artistry, and attention to detail that
            went into the making of the Emman Clutch didn&apos;t go unnoticed.
            In the last edition of Manila FAME 2023, it won the Katha Award for
            Best Product Design for Fashion.
            <br />
            <br />
            Set to once again captivate the market, Mele + Marie has an upcoming
            collection to be released in Spring 2024. Learn more by visiting
            their <br />
            <a
              href="#"
