...
export const ExhibitFirstSection = () => {
  return (
        ...
        <div className="px-[10%] py-[8%] w-full h-full">
          <div className="w-full h-full flex flex-col gap-6">
            ...
            <div className="w-full flex flex-col gap-1.5">
              <p>
                <span className="text-5xl font-bold">$ 1,100</span> / Starting
                Bid
              </p>
              ...
              <p className="flex items-center gap-2">
                ...
                {/* countdown */}
                <span className="text-xs">Starts in 2d : 11h : 46m : 22s</span>
              </p>
            </div>
            <button className="uppercase p-3 w-44 text-timeless-white bg-secondary-5 font-medium">Place bid</button>
          </div>
        </div>
      </div>
    </div>
